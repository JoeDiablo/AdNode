Contributing to Add Core
============================

The Add Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Add Core project, and is not to be
confused with overall Add Network Protocol consensus changes.

Whether a pull request is merged into Add Core rests with the project merge
...
Patches that change Add consensus rules are considerably more involved than
...
Where a patch set proposes to change the Add consensus, it must have been
...
The project leader is the release manager for each Add Core release.
