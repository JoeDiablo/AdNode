...
In order to support loading of multiple wallets in add-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is add.cpp.
...
Changes to add.cpp
----------------------
add.cpp is the entry point into add-qt, and as such, will require some minor modifications to provide hooks for
