...
This issue tracker is only for technical issues related to ADD Core.
General ADD questions and/or support requests and are best directed to the [ADD Discord](https://discord.add.org).
...
### What version of ADD Core are you using?
