...
RESOURCES += src/qt/add.qrc src/qt/add_locale.qrc

TRANSLATIONS += src/qt/locale/add_bg.ts \
                src/qt/locale/add_de.ts \
                src/qt/locale/add_en.ts \
                src/qt/locale/add_es.ts \
                src/qt/locale/add_fi.ts \
                src/qt/locale/add_fr.ts \
                src/qt/locale/add_it.ts \
                src/qt/locale/add_ja.ts \
                src/qt/locale/add_pl.ts \
                src/qt/locale/add_pt.ts \
                src/qt/locale/add_ru.ts \
                src/qt/locale/add_sk.ts \
                src/qt/locale/add_sv.ts \
                src/qt/locale/add_vi.ts \
                src/qt/locale/add_zh_CN.ts \
                src/qt/locale/add_zh_TW.ts
