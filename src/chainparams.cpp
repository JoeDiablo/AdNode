...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0xa9c1976a95efa5961553036503ec9015fb1dba2ca5e4076e0417f7e0670b2dc2"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1540663739, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60;         // Add: 1 day
        nTargetSpacing = 1 * 60;          // Add: 1 minutes
        ...
        nMaxMoneyOut = 20000000 * COIN;  //20m coins minted
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Add: 1 day
        nTargetSpacing = 1 * 60;  // Add: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 10;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet add addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet add script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet add BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet add BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet add BIP44 coin type is '1' (All coin's testnet default)
