                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Add from zAdd"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAdd"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAdd));
