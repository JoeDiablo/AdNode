/* src/config/add-config.h.  Generated from add-config.h.in by configure.  */
/* src/config/add-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.add.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Add Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Add Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "add"
