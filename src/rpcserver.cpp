...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Add features */
        {"add", "masternode", &masternode, true, true, false},
        {"add", "listmasternodes", &listmasternodes, true, true, false},
        {"add", "getmasternodecount", &getmasternodecount, true, true, false},
        {"add", "masternodeconnect", &masternodeconnect, true, true, false},
        {"add", "masternodecurrent", &masternodecurrent, true, true, false},
        {"add", "masternodedebug", &masternodedebug, true, true, false},
        {"add", "startmasternode", &startmasternode, true, true, false},
        {"add", "createmasternodekey", &createmasternodekey, true, true, false},
        {"add", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"add", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"add", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"add", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"add", "getmasternodescores", &getmasternodescores, true, true, false},
        {"add", "mnbudget", &mnbudget, true, true, false},
        {"add", "preparebudget", &preparebudget, true, true, false},
        {"add", "submitbudget", &submitbudget, true, true, false},
        {"add", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"add", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"add", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"add", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"add", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"add", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"add", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"add", "checkbudgets", &checkbudgets, true, true, false},
        {"add", "mnsync", &mnsync, true, true, false},
        {"add", "spork", &spork, true, true, false},
        {"add", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"add", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use addd, or the -server option to add-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> add-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12152/\n";
}
